...
<section id="why" class="why">
    <div class="container">
        <div class="why__main">
            ...
            <ul class="why__list">
                <li class="why__item">
                    <img src="img/engineer.png" alt="" class="why__item__img">
                ...
                <li class="why__item">
                    <img src="img/no-entry.png" alt="" class="why__item__img">
                ...
                <li class="why__item">
                    <img src="img/compass.png" alt="" class="why__item__img">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item1.png" alt="" class="services__item__img">
                ...
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item2.png" alt="" class="services__item__img">
                        <div class="services__item__name">Prace hydrauliczne</div>
                        <p class="services__item__text">
                            Z łatwością zadbamy o Państwa przyjemność
                            z korzystania z ogrodu. Zamontujemy
                ...
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item3.png" alt="" class="services__item__img">
                        <div class="services__item__name">Prace hydrauliczne</div>
                        <p class="services__item__text">
                            Z łatwością zadbamy o Państwa przyjemność
                            z korzystania z ogrodu. Zamontujemy
                ...
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item4.png" alt="" class="services__item__img">
                        <div class="services__item__name">Prace hydrauliczne</div>
                        <p class="services__item__text">
                            Z łatwością zadbamy o Państwa przyjemność
                            z korzystania z ogrodu. Zamontujemy
                ...
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item5.png" alt="" class="services__item__img">
                        <div class="services__item__name">Prace hydrauliczne</div>
                        <p class="services__item__text">
                            Z łatwością zadbamy o Państwa przyjemność
                            z korzystania z ogrodu. Zamontujemy
                ...
                <div class="col-xl-4">
                    <div class="services__item">
                        <img src="img/item6.png" alt="" class="services__item__img">
                        <div class="services__item__name">Prace hydrauliczne</div>
                        <p class="services__item__text">
                            Z łatwością zadbamy o Państwa przyjemność
                            z korzystania z ogrodu. Zamontujemy
        ...
        <div class="reviews__main">
            ...
            <div class="carousel reviews__carousel" data-flickity='{ "groupCells": true }'>
                ...
                <div class="carousel-cell reviews__carousel-cell">
                    <img src="img/img.png" alt="" class="reviews__img">
    ...
    <div class="container">
        <div class="contact__main">
            <div class="row">
                ...
                <div class="col-xl-5">
                    <img src="img/2s.png" alt="" class="contact__img">
                </div>
            </div>
        </div>
    </div>
